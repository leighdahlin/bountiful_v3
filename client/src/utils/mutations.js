...
export const UPDATE_USER = gql`
  mutation updateUser($first_name: String!, $last_name: String!, $location: String!, $email: String!) {
    updateUser(first_name: $first_name, last_name: $last_name, location:$location, email: $email) {
        _id
        first_name
        last_name
        location
